...
USAGE = """
Usage: grails s2-quickstart <domain-class-package> <user-class-name> <user-class-name> [requestmap-class-name]

Creates a user and user class (and optionally a requestmap class) in the specified package
