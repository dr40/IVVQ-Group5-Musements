...
class SpringSecurityService {
	...
	/**
	 * Delete a user, and if Requestmap class is used to store roles, remove the user
	 * from all Requestmap definitions. If a Requestmap's config attribute is this user,
	 * it will be deleted.
	 *
	...
	void deleteRole(role) {
		...
		// remove the user grant from all users
	...
	/**
	 * Update a user, and if Requestmap class is used to store roles, replace the new user
	 * name in all Requestmap definitions that use it if the name was changed.
	 *
	 * @param role the user to update
	 * @param newProperties the new user attributes ('params' from the calling controller)
	 */
	@Transactional
