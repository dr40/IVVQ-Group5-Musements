...
public final class SpringSecurityUtils {
   ...
   public static final String DEFAULT_TARGET_PARAMETER = "spring-security-redirect";
	...
	/**
	 * Extract the user names from authorities.
	...
	public static Collection<GrantedAuthority> getPrincipalAuthorities() {
		...
		// remove the fake user if it's there
	...
	/**
	 * Split the user names and create {@link GrantedAuthority}s for each.
	 * @param roleNames comma-delimited user names
	 ...
	 * @param roles a comma-delimited list of user names
