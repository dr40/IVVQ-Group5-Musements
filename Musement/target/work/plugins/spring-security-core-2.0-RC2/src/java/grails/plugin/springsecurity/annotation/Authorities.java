 ...
 * class will replace with an @Secured annotation with the associated user names.
 *
...
public @interface Authorities {
	/**
	 * The property file key; the property value will be a comma-delimited list of user names.
	 * @return the key
	 */
	String value();
}
